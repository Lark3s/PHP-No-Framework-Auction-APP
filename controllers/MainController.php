<?php
    ...
    class MainController extends Controller {
        ...
        public function postRegister() {
            ...
            $forename   = filter_input(INPUT_POST, 'reg_forename', FILTER_UNSAFE_RAW);
            $surname    = filter_input(INPUT_POST, 'reg_surname', FILTER_UNSAFE_RAW);
            $username   = filter_input(INPUT_POST, 'reg_username', FILTER_UNSAFE_RAW);
            $password1  = filter_input(INPUT_POST, 'reg_password_1', FILTER_UNSAFE_RAW);
            $password2  = filter_input(INPUT_POST, 'reg_password_2', FILTER_UNSAFE_RAW);
        ...
        public function postLogin() {
            $username = filter_input(INPUT_POST, 'login_username', FILTER_UNSAFE_RAW);
            $password = filter_input(INPUT_POST, 'login_password', FILTER_UNSAFE_RAW);
